...
class TestBinarySearch(unittest.TestCase):
    ...
    def test_template2(self):
        ...
        target2 = 9
        self.assertEqual(-1, binary_search_template_1(nums, target1))
        self.assertEqual(4, binary_search_template_1(nums, target2))
        self.assertEqual(0, binary_search_template_1(nums2, target1))
        self.assertEqual(-1, binary_search_template_1([], target2))
    ...
    def test_template3(self):
        ...
        self.assertEqual(-1, binary_search_template_1(nums, target1))
        self.assertEqual(4, binary_search_template_1(nums, target2))
        self.assertEqual(2, binary_search_template_1(nums, target3))
        self.assertEqual(0, binary_search_template_1(nums, target4))
        self.assertEqual(0, binary_search_template_1(nums2, target1))
        self.assertEqual(-1, binary_search_template_1([], target4))
